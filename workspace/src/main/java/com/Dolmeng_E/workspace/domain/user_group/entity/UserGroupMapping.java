...
public class UserGroupMapping {
    ...
    @Id
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "user_group_mapping_seq_generator")
    @GenericGenerator(
            name = "user_group_mapping_seq_generator", // generator 이름
            strategy = "com.Dolmeng_E.workspace.common.domain.StringPrefixedSequenceIdGenerator", // 1단계에서 만든 클래스 경로
            parameters = {
                    @org.hibernate.annotations.Parameter(name = "sequence_name", value = "user_group_mapping_seq"), // DB에 생성할 시퀀스 이름
                    ...
                    @Parameter(name = "valuePrefix", value = "user_grp_map_") // ID에 붙일 접두사!
            }
    )
    private String id;
